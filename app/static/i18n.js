...
const DICT = {
  zh: {
    ...
    "opt.inventoryWhy": "列出所有套件（含間接相依）與它們的授權。不勾選只能列出專案直接宣告的套件。",
    "opt.inventorySends": "傳送內容：套件名稱與版本條件（例如 fastapi、>=0.111）。",
    "opt.inventoryDest": "傳送對象：Google 的 api.deps.dev——osv-scanner 用它把版本範圍解析成實際版本並取得授權。",
    "opt.inventoryNot": "不會傳送：原始程式碼、檔案內容、檔名、密鑰或任何掃描發現。",
    "opt.inventoryCost": "實測約 88 KB。封鎖網路或不愿透露相依清單（例如掃描客戶的私有程式碼）時請不要勾選。",
    "sec.results": "結果",
    ...
    "set.group.mcp": "MCP",
    "set.group.docker": "Docker 規格",
    "dk.title": "Docker 規格",
    "dk.intro": "調整容器可用的記憶體與 CPU。填好之後會產生一段 docker-compose 設定，複製到 docker-compose.yml 再重新部署即可生效。",
    "dk.host": "這台主機：記憶體 {mem}、{cpus} 核心。上限不能超過這個數字。",
    "dk.off": "Docker 監控未啟用，因此讀不到目前的規格。",
    "dk.unlimited": "無上限 ⚠",
    "dk.col.service": "服務",
    "dk.col.memNow": "目前記憶體上限",
    "dk.col.memUsed": "實際用量",
    "dk.col.cpuNow": "目前 CPU 上限",
    "dk.col.memWant": "要設定的記憶體",
    "dk.col.cpuWant": "要設定的 CPU",
    "dk.generate": "產生設定",
    "dk.copy": "複製",
    "dk.copied": "已複製。",
    "dk.copyManual": "已選取，請按 Ctrl+C 複製（瀏覽器在非 HTTPS 下不允許自動複製）。",
    "dk.nothing": "兩個欄位都空白，沒有東西可以產生。",
    "dk.failed": "產生設定失敗。",
    "dk.resultHint": "把這段貼進 docker-compose.yml，與既有的 services: 合併。",
    "dk.applyHint": "套用：貼上後執行 ./scripts/deploy.sh。本頁不會自己改你的容器。",
    "set.group.logs": "Log",
    "logs.title": "Log",
    "logs.scopeAll": "顯示這台部署的完整活動紀錄（管理員檢視）：掃描、登入、服務與容器狀態、API 與 MCP 呼叫。",
    "logs.scopeMine": "只顯示你自己的活動紀錄。",
    "logs.none": "目前沒有符合條件的紀錄。",
    "logs.all": "全部",
    "logs.anyLevel": "所有層級",
    "logs.searchHint": "搜尋帳號、IP、標的或說明…",
    "logs.showing": "顯示最近 {n} 筆，符合條件共 {total} 筆。",
    "logs.total": "共 {total} 筆。",
    "logs.retention": "保留天數",
    "logs.retentionHint": "超過天數的紀錄會直接刪除；儲存後立即生效。",
    "logs.save": "儲存",
    "logs.saveFailed": "保留天數儲存失敗。",
    "logs.col.at": "時間",
    "logs.col.category": "類別",
    "logs.col.action": "動作",
    "logs.col.actor": "帳號",
    "logs.col.source": "來源 IP",
    "logs.col.target": "標的",
    "logs.col.detail": "說明",
    "logs.cat.scan": "掃描",
    "logs.cat.auth": "登入",
    "logs.cat.service": "服務",
    "logs.cat.docker": "容器",
    "logs.cat.api": "API/MCP",
    "logs.act.start": "開始",
    "logs.act.stop": "停止",
    "logs.act.restart": "重啟",
    "logs.act.login": "登入",
    "logs.act.state": "狀態變化",
    "logs.act.capacity": "資源吃緊",
    "logs.act.call": "呼叫",
    "logs.act.mcp": "MCP",
    "logs.act.retention": "保留設定",
    "logs.level.info": "資訊",
    "logs.level.warn": "警告",
    "logs.level.error": "錯誤",
  ...
  en: {
    ...
    "opt.inventoryWhy": "Lists every package, including transitive ones, and its licence. Unticked, only the packages the project declares are listed.",
    "opt.inventorySends": "Sent: package names and version constraints (for example fastapi, >=0.111).",
    "opt.inventoryDest": "Sent to: Google's api.deps.dev \u2014 osv-scanner uses it to resolve a version range to a real release and look up the licence.",
    "opt.inventoryNot": "Not sent: source code, file contents, file names, secrets, or any scan finding.",
    "opt.inventoryCost": "About 88 KB, measured. Leave it unticked on an air-gapped network, or when the dependency list itself is sensitive \u2014 a client's private code, for instance.",
    "sec.results": "Results",
    ...
    "set.group.mcp": "MCP",
    "set.group.docker": "Docker resources",
    "dk.title": "Docker resources",
    "dk.intro": "Set how much memory and cpu each container may use. Filling these in produces a docker-compose snippet; paste it into docker-compose.yml and redeploy to apply it.",
    "dk.host": "This host has {mem} of memory and {cpus} cpus. A limit cannot exceed that.",
    "dk.off": "Docker monitoring is off, so the current limits cannot be read.",
    "dk.unlimited": "no limit \⚠",
    "dk.col.service": "Service",
    "dk.col.memNow": "Memory limit now",
    "dk.col.memUsed": "In use",
    "dk.col.cpuNow": "CPU limit now",
    "dk.col.memWant": "Memory wanted",
    "dk.col.cpuWant": "CPU wanted",
    "dk.generate": "Generate",
    "dk.copy": "Copy",
    "dk.copied": "Copied.",
    "dk.copyManual": "Selected \— press Ctrl+C. (Browsers block scripted copying outside HTTPS.)",
    "dk.nothing": "Both fields are empty, so there is nothing to generate.",
    "dk.failed": "Could not generate the snippet.",
    "dk.resultHint": "Paste this into docker-compose.yml, merging it with the services already there.",
    "dk.applyHint": "To apply: paste it, then run ./scripts/deploy.sh. This page does not change your containers.",
    "set.group.logs": "Log",
    "logs.title": "Log",
    "logs.scopeAll": "Everything this deployment did (administrator view): scans, logins, service and container state, API and MCP calls.",
    "logs.scopeMine": "Only your own activity.",
    "logs.none": "Nothing matches these filters.",
    "logs.all": "All",
    "logs.anyLevel": "Any level",
    "logs.searchHint": "Search account, IP, target or detail\u2026",
    "logs.showing": "Showing the latest {n} of {total} matching rows.",
    "logs.total": "{total} rows.",
    "logs.retention": "Keep for (days)",
    "logs.retentionHint": "Anything older is deleted, as soon as you save.",
    "logs.save": "Save",
    "logs.saveFailed": "Could not save the retention setting.",
    "logs.col.at": "Time",
    "logs.col.category": "Category",
    "logs.col.action": "Action",
    "logs.col.actor": "Account",
    "logs.col.source": "Source IP",
    "logs.col.target": "Target",
    "logs.col.detail": "Detail",
    "logs.cat.scan": "Scan",
    "logs.cat.auth": "Login",
    "logs.cat.service": "Service",
    "logs.cat.docker": "Container",
    "logs.cat.api": "API/MCP",
    "logs.act.start": "started",
    "logs.act.stop": "stopped",
    "logs.act.restart": "restarted",
    "logs.act.login": "sign-in",
    "logs.act.state": "state change",
    "logs.act.capacity": "under pressure",
    "logs.act.call": "call",
    "logs.act.mcp": "MCP",
    "logs.act.retention": "retention",
