...
const DICT = {
  zh: {
    ...
    "logins.none": "尚無紀錄",
    "matrix.title": "掃描工具說明",
    "matrix.hint": "「某個工具沒找到東西」通常不是它漏掉了，而是它本來就不看那種東西。",
    "matrix.tool": "工具",
    "matrix.kind": "類別",
    "matrix.looksAt": "看什麼",
    "matrix.finds": "找得到什麼",
  ...
  en: {
    ...
    "matrix.hint": "\u201cThis tool found nothing\u201d usually means it was never looking at that kind of thing, not that it missed something.",
    "matrix.tool": "Tool",
    "matrix.kind": "Kind",
    "matrix.looksAt": "Looks at",
    "matrix.finds": "Finds",
    "matrix.custom": "Custom rules",
    "matrix.yes": "yes",
    "matrix.no": "no",
