...
const DICT = {
  zh: {
    ...
    "policy.rule.critical_block": "Critical 一律阻擋",
    "policy.rule.high_manual_review": "High 需要人工審查",
    "policy.rule.secret_block": "Secret 一律阻擋",
    "policy.rule.false_positive_exception": "誤報例外需記錄負責人、理由與到期日",
    "policy.rule.report_retention": "報告保存期限",
    "policy.rule.requirePr": "PR 前必須掃描",
    "policy.rule.requireRelease": "Release 前必須掃描",
    "policy.days": "天",
    ...
    "policy.tpl.standard.desc": "阻擋 Critical 與 Secret；High 需要人工審查；適合一般團隊日常掃描。",
    "policy.tpl.strict": "嚴格",
    "policy.tpl.strict.desc": "所有 PR 與 Release 前都必須掃描，並阻擋 Critical、Secret，High 需審查。",
    "policy.tpl.report_only": "僅報告",
    "policy.tpl.report_only.desc": "只產生報告，不阻擋掃描；適合導入初期建立基準線。",
  ...
  en: {
    ...
    "policy.rule.critical_block": "Block on Critical findings",
    "policy.rule.high_manual_review": "High findings need manual review",
    "policy.rule.secret_block": "Block on secrets",
    "policy.rule.false_positive_exception": "False-positive exceptions need owner, reason and expiry",
    "policy.rule.report_retention": "Report retention",
    "policy.rule.requirePr": "Require a scan before pull requests",
    "policy.rule.requireRelease": "Require a scan before releases",
    "policy.days": "days",
