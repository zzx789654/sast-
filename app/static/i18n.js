...
const DICT = {
  zh: {
    ...
    "mon.updateHintDocker": "上方顯示的是**容器內**的版本。`./setup.sh --update` 只裝到主機，改不了這裡——要換版本請先改 Dockerfile 的版本釘選，再跑 ./scripts/deploy.sh 重建映像。",
  ...
  en: {
    ...
    "mon.updateHintDocker": "The versions above are the ones **inside the container**. ./setup.sh --update installs onto the host and cannot change them \u2014 to change a version, edit the pins in the Dockerfile and rebuild with ./scripts/deploy.sh.",
