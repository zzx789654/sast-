...
const DICT = {
  zh: {
    ...
    "ruleset.legend": "Semgrep 規則集",
    "ruleset.hint": "可複選，semgrep 會把選中的規則集聯集起來一起跑。（不提供 auto：它與本專案固定使用的 --metrics=off 衝突。）",
    ...
    "rules.save": "儲存",
    "rules.delete": "刪除",
    "rules.enable": "這次掃描要套用的自訂規則（可複選；預設規則集仍會一起跑）",
    "rules.none": "還沒有任何規則",
    "rules.ok": "規則可用",
    "rules.bad": "規則無法使用",
  ...
  en: {
    ...
    "ruleset.legend": "Semgrep rulesets",
    "ruleset.hint": "Pick any number; semgrep runs the union of them. (No “auto”: it conflicts with the --metrics=off this project always scans with.)",
    ...
    "rules.save": "Save",
    "rules.delete": "Delete",
    "rules.enable": "Custom rules to apply to this scan (the default ruleset still runs too)",
